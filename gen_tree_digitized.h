...
// Tue Jul 21 10:15:11 2026 by ROOT version 6.30/04
// from TTree T/Geant4 SBS Simulation
// found on file: GEN4_He3_elastic_job_0.root
//////////////////////////////////////////////////////////

#ifndef gen_tree_digitized_h
#define gen_tree_digitized_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Earm_BBPS_det_SumPhotoelectrons;
   ...
   Int_t           Earm_BBSH_det_SumPhotoelectrons;
   ...
   Int_t           Harm_HCal_det_SumPhotoelectrons;
   ...
   Int_t           Harm_SBSGEM_dighit_nstrips;
   vector<int>     *Harm_SBSGEM_dighit_module;
   vector<int>     *Harm_SBSGEM_dighit_strip;
   vector<int>     *Harm_SBSGEM_dighit_adc;
   vector<int>     *Harm_SBSGEM_dighit_samp;
   ...
   TBranch        *b_Earm_BBPS_det_SumPhotoelectrons;   //!
   ...
   TBranch        *b_Earm_BBSH_det_SumPhotoelectrons;   //!
   ...
   TBranch        *b_Harm_HCal_det_SumPhotoelectrons;   //!
   ...
   TBranch        *b_Harm_SBSGEM_dighit_nstrips;   //!
   TBranch        *b_Harm_SBSGEM_dighit_module;   //!
   TBranch        *b_Harm_SBSGEM_dighit_strip;   //!
   TBranch        *b_Harm_SBSGEM_dighit_adc;   //!
   TBranch        *b_Harm_SBSGEM_dighit_samp;   //!

   gen_tree_digitized(TTree *tree=0);
   virtual ~gen_tree_digitized();
...
#ifdef gen_tree_digitized_cxx
gen_tree_digitized::gen_tree_digitized(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("GEN4_He3_elastic_job_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("GEN4_He3_elastic_job_0.root");
      }
      f->GetObject("T",tree);
...
gen_tree_digitized::~gen_tree_digitized()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gen_tree_digitized::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gen_tree_digitized::LoadTree(Long64_t entry)
{
...
void gen_tree_digitized::Init(TTree *tree)
{
   ...
   Harm_SBSGEM_dighit_module = 0;
   Harm_SBSGEM_dighit_strip = 0;
   Harm_SBSGEM_dighit_adc = 0;
   Harm_SBSGEM_dighit_samp = 0;
   ...
   fChain->SetBranchAddress("Earm.BBPS.det.SumPhotoelectrons", &Earm_BBPS_det_SumPhotoelectrons, &b_Earm_BBPS_det_SumPhotoelectrons);
   ...
   fChain->SetBranchAddress("Earm.BBSH.det.SumPhotoelectrons", &Earm_BBSH_det_SumPhotoelectrons, &b_Earm_BBSH_det_SumPhotoelectrons);
   ...
   fChain->SetBranchAddress("Harm.HCal.det.SumPhotoelectrons", &Harm_HCal_det_SumPhotoelectrons, &b_Harm_HCal_det_SumPhotoelectrons);
   ...
   fChain->SetBranchAddress("Harm.SBSGEM.dighit.nstrips", &Harm_SBSGEM_dighit_nstrips, &b_Harm_SBSGEM_dighit_nstrips);
   fChain->SetBranchAddress("Harm.SBSGEM.dighit.module", &Harm_SBSGEM_dighit_module, &b_Harm_SBSGEM_dighit_module);
   fChain->SetBranchAddress("Harm.SBSGEM.dighit.strip", &Harm_SBSGEM_dighit_strip, &b_Harm_SBSGEM_dighit_strip);
   fChain->SetBranchAddress("Harm.SBSGEM.dighit.adc", &Harm_SBSGEM_dighit_adc, &b_Harm_SBSGEM_dighit_adc);
   fChain->SetBranchAddress("Harm.SBSGEM.dighit.samp", &Harm_SBSGEM_dighit_samp, &b_Harm_SBSGEM_dighit_samp);
   Notify();
}

Bool_t gen_tree_digitized::Notify()
{
...
void gen_tree_digitized::Show(Long64_t entry)
{
...
Int_t gen_tree_digitized::Cut(Long64_t entry)
{
...
#endif // #ifdef gen_tree_digitized_cxx
